...
def workflow(in_images, out_path,
    ...
    for neubias_input_image in in_images:
        ...
        command = "/usr/bin/xvfb-run Vaa3D_CentOS_64bit_v3.458/vaa3d -x /Vaa3D_CentOS_64bit_v3.458/plugins/neuron_tracing/MST_tracing/libneurontracing_mst.so -f trace_mst -i {} -o {}.swc " \
        ...
        os.rename("{}_MST_Tracing.swc".format(out_file_path),"{}.swc".format(out_file_path[:-4]))
